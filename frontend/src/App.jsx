...
function PaymentReceipt({ payment, onClose }) {
  ...
  const paid = Number(payment.paidAmount ?? payment.paid_amount ?? 0);
    ...
    <div className="receipt-overlay">
      <div className="payment-receipt">
        ...
        <div className="receipt-header">
          <img
            src={`${import.meta.env.BASE_URL}riiroow-logo.png`}
            alt="Riiroow Apartments"
            className="receipt-logo"
          />
          <div>
            <div className="receipt-title">PAYMENT RECEIPT</div>
            <div className="receipt-subtitle">
              Riiroow Apartment Management
            </div>
          </div>
        </div>
        ...
        <div className="receipt-meta">
          ...
          <div>
            <span>Reference</span>
            <strong>{String(reference).slice(0, 18)}</strong>
          </div>
        </div>
        ...
        <div className="receipt-footer">
          ...
          <span>This receipt was generated by Riiroow Apartment Management.</span>
        </div>
      </div>
    </div>
  );
